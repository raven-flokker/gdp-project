	...
	<div class="signin-block-reg">
		<form class="form-inline my-2 my-lg-0">
			...
			if (isset($_SESSION['auth'])) {
				...
				echo LANG_HELLO . '  <a href="#">' . $_SESSION['login'] . ' </a>  <a href="logout.php">' . LANG_SINGOUT . '</a>';
			} else {
				echo '
...
<div class="header-block">
	<div class="header-content d-flex align-items-center">
		<div class="header-content-logo"><img src="/assets/img/logo.png" alt="Логотип" /></div>
	</div>
	<!-- /.header-content -->
</div>
<!-- /.header-block -->
...
<div class="pt-1 pb-1d">
	<nav class="navbar navbar-expand-lg navbar-light justify-content-between">
		<div class="header-logo"><?= LANG_MENU ?></div>
		...
		<div class="collapse navbar-collapse" id="navbarText">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link nav-link-item" href="#"><?= LANG_INFO ?></a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link nav-link-item" href="#"><?= LANG_ORGCONF ?></a>
				</li>
			</ul>
		</div>
	</nav>
